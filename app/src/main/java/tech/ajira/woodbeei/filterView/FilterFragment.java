...
public class FilterFragment extends AAH_FabulousFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        applied_filters = ((ProductListActivity) getActivity()).getApplied_filters();
...
//            ll_scroll.setLayoutParams(lp);
    ...
    private void inflateLayoutWithFilters(final String filter_category, FlexboxLayout fbl) {
        ...
        switch (filter_category) {
            case "genre":
                keys = ((ProductListActivity) getActivity()).getmData().getUniqueGenreKeys();
                break;
            case "rating":
                keys = ((ProductListActivity) getActivity()).getmData().getUniqueRatingKeys();
                break;
            case "year":
                keys = ((ProductListActivity) getActivity()).getmData().getUniqueYearKeys();
                break;
            case "quality":
                keys = ((ProductListActivity) getActivity()).getmData().getUniqueQualityKeys();
                break;
        }
